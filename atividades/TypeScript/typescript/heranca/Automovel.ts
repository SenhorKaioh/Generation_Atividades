...
export class Automovel extends Terrestre{
	...
	constructor(capacidade:number, numeroRodas: number,velocidade:number ,cor: string, numeroPortas: number, placa: string, marchas: number) {
...
public caulcularIpva(valor:number): void{
